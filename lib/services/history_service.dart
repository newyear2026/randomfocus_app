...
class HistoryService {
  ...
  static Future<Map<String, dynamic>> getStatistics() async {
    ...
    final completedSessions = histories.where((h) => h.status == SessionStatus.completed).length;
    final stoppedSessions = histories.where((h) => h.status == SessionStatus.stopped).length;
